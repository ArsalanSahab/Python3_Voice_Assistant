...
def get_audio(ask_user = False):
    ...
    with sr.Microphone() as source :
        ...
        # Handle Exception if Audio is not recognizeable
            ...
            friday_speak("Sorry I dint get that , can you please repeat ?")
        
        # Handle Exception if error in service
        except sr.RequestError :

            friday_speak("Sorry , there was an error with google services.")
...
def main():
    ...
    time.sleep(1)
    friday_speak("Hello , I am Friday !")
    while 2 :
